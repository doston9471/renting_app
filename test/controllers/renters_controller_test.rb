...
class RentersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create renter" do
    assert_difference('Renter.count') do
      post renters_url, params: { renter: { car_id: @renter.car_id, email: @renter.email, first_name: @renter.first_name, last_name: @renter.last_name, phone: @renter.phone } }
    end
  ...
  test "should update renter" do
    patch renter_url(@renter), params: { renter: { car_id: @renter.car_id, email: @renter.email, first_name: @renter.first_name, last_name: @renter.last_name, phone: @renter.phone } }
